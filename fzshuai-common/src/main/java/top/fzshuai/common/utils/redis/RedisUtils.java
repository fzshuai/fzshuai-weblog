package top.fzshuai.common.utils.redis;
...
public class RedisUtils {
     ...
     * @return 缓存数据的对象
     */
    public static <T> boolean setCacheSet(final String key, final T member) {
        RSet<T> rSet = CLIENT.getSet(key);
        return rSet.add(member);
    }
     ...
     * @return 指定元素分数
     */
    public static <T> Double getCacheSortedSetScore(final String key, final T member) {
     ...
     * @param delta  递增条件
     */
    public static <T> void incrCacheSortedSetScore(final String key, final T member, Double delta) {
        RScoredSortedSet<Object> rZSet = CLIENT.getScoredSortedSet(key);
        rZSet.addScore(member, delta);
    }
     ...
     * @param delta 递增条件
     */
    public static void incrCacheMapValue(final String key, final String hKey, Long delta) {
        RMap<String, T> rMap = CLIENT.getMap(key);
        rMap.addAndGet(hKey, delta);
    }
     ...
     * @param delta 递减条件
     */
    public static void decrCacheMapValue(final String key, final String hKey, Long delta) {
        RMap<String, T> rMap = CLIENT.getMap(key);
        rMap.addAndGet(hKey, -delta);
    }
